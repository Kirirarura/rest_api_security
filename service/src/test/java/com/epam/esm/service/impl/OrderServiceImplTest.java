...
class OrderServiceImplTest {
    ...
    private Order getOrder() {
        ...
        return new Order(1L, new BigDecimal("15.2"), PURCHASE_DATE, getUser(),
    ...
    private List<Order> getOrders() {
        return Arrays.asList(
                new Order(1L, new BigDecimal("15.2"), PURCHASE_DATE, getUser(),
                        new GiftCertificate(1L, "giftCertificate1", "description1", new BigDecimal("10.1"),
                                10, String.valueOf(Instant.now()), String.valueOf(Instant.now()), null)),
                new Order(2L, new BigDecimal("20.2"), PURCHASE_DATE, getUser(),
